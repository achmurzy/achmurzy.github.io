...
Generator.prototype.RandomInsideBox = function()
{
...
Generator.prototype.InsideBox = function(point) 
{
...
Generator.prototype.baseLine = function(connectStart=null)
{
	var start;
...
Generator.prototype.generateLine = function(start, end)
{
...
Generator.prototype.baseQuadratic = function(connectStart=null)
{
...
Generator.prototype.generateQuadratic = function(start, control_point, end)
{	
...
Generator.prototype.baseCubic = function(connectStart=null)
{
	var line = this.baseLine(connectStart);
...
Generator.prototype.generateCubic = function(start, control_point_1, control_point_2, end)
{
	var spos = start.clone();
	var sneg = start.clone();
